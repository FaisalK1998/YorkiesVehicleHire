...
namespace Documentation
{
    ...
    [HelpFileBuilderPlugInExport("Documentation", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "Documentation plug-in")]
    public sealed class DocumentationPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In DocumentationPlugIn Execute() method");
        }
        #endregion
